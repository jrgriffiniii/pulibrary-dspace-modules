...
/**
 * Dummy Discovery IndexEventConsumer. It essentially does nothing, as Discovery/Solr is not
 * actively running during unit testing.
 *
 * @author tdonohue
 */
public class MockIndexEventConsumer extends MockUp<IndexEventConsumer> {
  @Mock
